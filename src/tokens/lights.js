// tokens/lights.js
// Named point-light presets attached to appliances. Every fixture is a plain
// omnidirectional PointLight — no spotlight cones, no realtime shadow casting
// (reverted per feedback: the spotlight+shadow setup was "too heavy" for what
// it added; only the moon's structural shadow remains, unrelated to this).
// Reach is capped via each light's `distance`, not a cone, to keep it from
// spilling too far into neighboring rooms.
...
export const LightTokens = {
  ...
  warmCeiling:     { color: 0xffe5b0, intensity: 1.4, distance: 9, decay: 1.5 }, // ceiling-fan lamp
